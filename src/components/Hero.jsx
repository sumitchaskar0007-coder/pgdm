			...
			<Helmet>
				<script type="application/ld+json">
					{JSON.stringify({
						...
						"name":"AIM | PGDM - Aditya Institute of Management",
						"address":{"@type":"PostalAddress","addressLocality":"Pune","addressRegion":"MH","addressCountry":"IN"},
						"url":"https://adityainstitutepgdm.com"
					})}
				</script>
			</Helmet>
			<div className="container-responsive py-12 md:py-20 grid gap-8 md:grid-cols-2 items-center">
				<div>
					<p className="text-sm font-semibold text-primary mb-2">Shaping future-ready business leaders</p>
					<h1 className="font-display text-3xl md:text-5xl font-bold leading-tight">
						Industry-Focused PGDM Program — Apply Now for 2026 Admission.
					</h1>
					<p className="mt-4 text-gray-700 max-w-2xl">
						Contemporary management education combining academic rigour,
						industry immersion, internships, and leadership development.
					</p>
				...
				<div className="relative">
					<div className="aspect-[4/3] w-full rounded-2xl bg-gray-200 overflow-hidden shadow-lg">
						<img src="/assets/hero.jpg" alt="AIM | PGDM - Aditya Institute of Management campus" className="w-full h-full object-cover" loading="eager" />
					</div>
				</div>
			</div>
		</section>
